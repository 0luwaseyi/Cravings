...
const Order =()=>{
    return(
        <div>
            <div className="">
                <Image src = "/blackback.svg" alt="background" width={1500} height={400}/>
            </div>

            <div className="flex flex-row mt-[-25vw] ml-[8vw] space-x-[10vw]">
            <div className="flex flex-col space-y-4 w-[36vw] ">
                <h1 className="font-bold text-[#fff] text-2xl">Place an order with our mobile app</h1>
